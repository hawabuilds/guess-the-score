# Guess the Score — Community FAQ

Plain answers to common questions. Share this link with anyone new to the game.

**Play at:** [guessthescore.xyz](https://guessthescore.xyz)  
**Legal disclaimer:** [guessthescore.xyz/disclaimer](https://guessthescore.xyz/disclaimer)

---

## The basics

### What is Guess the Score?
...
No — it’s positioned as a **skill-based prediction game**, not a sportsbook or casino. Nothing on the site is financial or gambling advice. See the full [disclaimer](https://guessthescore.xyz/disclaimer). **Check your local laws** — eligibility varies by region.

### Is Guess the Score official FIFA / a league / a club?
...
**DYOR.** Token prices can go up or down. Nothing here is investment advice. See our [disclaimer](https://guessthescore.xyz/disclaimer).
...
Go to [guessthescore.xyz](https://guessthescore.xyz) and **Sign in with X**. That links your game profile to your X account.
...
1. Open the match from the app (or find the post from **@guessthescoreX**).
...
Match threads are posted by **@guessthescoreX** (unless we announce otherwise). Your reply must be on **that match post**, not a random tweet.
...
| Wrong thread (not the official match post) | Reply under **@guessthescoreX**’s post for that fixture |
...
| **1 – 5** | **10%** each (Tier 1) |
| **6 – 10** | **5%** each (Tier 2) |
| **11 – 20** | **2.5%** each (Tier 3) |

On a **$1,500** pool: **$150** / **$75** / **$37.50** per winner.
...
- Predictions: replies to @guessthescoreX match posts, collected after kickoff.
...
**Disclaimer:** Skill-based prediction game. Not financial advice. Eligibility varies by region. [Full disclaimer →](https://guessthescore.xyz/disclaimer)
