  ...
  const rows = [
      {
        ...
        description:
          "Film your best goal celebration and post it with #GuessTheScore. Most creative entry wins.\n\nRules:\n- 60 seconds max\n- Tag @guessthescoreX in the post",
      ...
      {
        title: `${TEST_PREFIX}Explain Guess the Score in 30 seconds`,
        description:
  ...
  const submissionSpecs = [
    {
      ...
      handle: "@testplayer1",
      accent: "#0066FF",
      postUrl: "https://x.com/guessthescoreX/status/1",
    },
    {
      bountyId: judging.id,
      ...
      handle: "@testplayer2",
      accent: "#3b5bd4",
      postUrl: "https://x.com/guessthescoreX/status/2",
    },
    {
      bountyId: paid.id,
      ...
      handle: "@testwinner",
      accent: "#d4683b",
      postUrl: "https://x.com/guessthescoreX/status/3",
    },
  ] as const;
