...
const LINK_PATTERN =
  /(guessthescore\.xyz\/disclaimer|guessthescore\.xyz\/faq)/g;
  ...
  return (
    <p className={styles.answer}>
      {parts.map((part, index) => {
        if (part === "guessthescore.xyz/disclaimer") {
          return (
            <Link
              key={index}
              href="/disclaimer"
            ...
            >
              guessthescore.xyz/disclaimer
            </Link>
          );
        }
        if (part === "guessthescore.xyz/faq") {
          return (
            <Link key={index} href="/faq" className={styles.inlineLink}>
              guessthescore.xyz/faq
            </Link>
          );
        }
        return part;
